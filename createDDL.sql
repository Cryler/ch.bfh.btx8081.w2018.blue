...
CREATE TABLE person (ID INTEGER NOT NULL, DTYPE VARCHAR(31), ADDRESS VARCHAR(255), BIRTHDATE BYTEA, CITY VARCHAR(255), EMAIL VARCHAR(255), FIRSTNAME VARCHAR(255), GENDER VARCHAR(255), LANGUAGE VARCHAR(255), LASTNAME VARCHAR(255), NATIONALITY VARCHAR(255), PHONENUMBER VARCHAR(255), AHVNR VARCHAR(255), INSURANCE VARCHAR(255), PRIMARY KEY (ID))
